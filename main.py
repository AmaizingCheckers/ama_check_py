...
FLAGS = flags.FLAGS
# 学習用データ
flags.DEFINE_string('train', '/Users/matsunaga/Desktop/dev/workspace/python/tensorflow/data/train/train.txt', 'File name of train data')
# 検証用データ
flags.DEFINE_string('test', '/Users/matsunaga/Desktop/dev/workspace/python/tensorflow/data/test/test.txt', 'File name of train data')
